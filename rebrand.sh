...
echo 'pref("app.update.url", "");' >> defaults/preferences/firefox.js
echo 'pref("app.update.url.manual", "https://parrotgeek.com/fxlegacy.html");' >> defaults/preferences/firefox.js
